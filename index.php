	...
	<div class="stage-container remove">
		<div class="canvas-container">
            ...
            <form action="loading.php">
                <input type="submit" value="Nhấn dô đây nèe" id="redirectButton" class="redirect-button"><div class="NewYear">Happy New Year AiLinh &#10084;</div>
            </form>
		...
		<div class="controls">
			...
			<div class="btn sound-btn">
				<svg fill="white" width="24" height="24"><use href="#icon-sound-on" xlink:href="#icon-sound-off"></use></svg>
			</div>
